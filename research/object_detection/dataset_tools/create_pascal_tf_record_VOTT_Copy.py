...
This script only works on dataset labeled by VoTT. 'anomaly' must be the only class of objects.

['--data_dir=', '--set=', '--output_path='] need to be filled in as args

use '--set=trainval' to zip all labeled images into TFrecord, otherwise only one set will be converted 
"""
...
flags.DEFINE_string('label_map_path', 'data/anomaly_label_map.pbtxt',
